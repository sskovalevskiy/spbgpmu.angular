...
const newsList: Array<Article> = [
  new Article(1,
    ...
    '2018-03-16',
    '2018-03-16',
    new Category(1, 'History', 'history'),
  ...
  new Article(2,
    ...
    '2018-03-16',
    '2018-03-16',
    new Category(1, 'Science', 'science'),
    new Author(1, 'Diego Balmaceda', ''),
    // tslint:disable-next-line:max-line-length
  ...
  new Article(7, 'Everything you need to know about Valkyries',
    ...
    '2018-03-16',
    '2018-03-16',
    new Category(3, 'History', 'history'),
    new Author(1, 'Diego Balmaceda', '')),
  new Article(8, 'Welcome to Ghost',
    ...
    '2018-03-16',
    '2018-03-16',
    new Category(4, 'Getting Started', 'getting-started'),
    new Author(1, 'Diego Balmaceda', '')),
  ...
  new Article(10, 'Organising your content with tags',
    ...
    '2018-03-16',
    '2018-03-16',
    new Category(1, 'Getting Started', 'getting-started'),
    new Author(1, 'Diego Balmaceda', '')),
